...
DAEMON_NAME = 'SMS-ingest storage server'
...
LOG_PATH = '/opt/citizendesk/log/citizendesk/sms_storage.log'
PID_PATH = '/opt/citizendesk/run/sms_storage.pid'
HOME_DIR = '/tmp'
...
def run_server():
    ...
    run_flask(params.get_db_name(), server=server_address, mongo=mongo_address, send_sms=params.get_send_sms(), debug=False)
...
if __name__ == '__main__':
    ...
    try:
        ...
        from citizendesk.ingest.sms.run import run_flask
    except:
