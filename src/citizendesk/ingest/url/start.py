...
DAEMON_NAME = 'URL-ingest storage server'
...
TLDS_PATH = '/opt/citizendesk/etc/citizendesk/effective_tld_names.dat'
LOG_PATH = '/opt/citizendesk/log/citizendesk/url_storage.log'
PID_PATH = '/opt/citizendesk/run/url_storage.pid'
HOME_DIR = '/tmp'
...
class ConnectParams():
    ...
    def use_specs(self):
        ...
        parser.add_argument('-t', '--tlds_path', help='path to file with effective TLDs')
    ...
    def get_tlds_path(self):
        return self.tlds_path
...
def run_server():
    ...
    run_flask(params.get_db_name(), server=server_address, mongo=mongo_address, tlds_path=params.get_tlds_path(), debug=False)
